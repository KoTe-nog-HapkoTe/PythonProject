...
async def get_cat_breed_from_gigachat():
    ...
    """
    prompts = [
        "Назови одну случайную породу кота с случайным смешным прилагательным. Ответ должен быть кратким, только название породы с прилагательным. Например: Печальный мейн-кун; Клоунский сиамец. Не добавляй никаких дополнительных слов."
    ]
