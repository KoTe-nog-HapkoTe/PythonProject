...
async def get_cat_breed_from_gigachat():
    ...
    """
    prompt = "Назови одну случайную породу кота с случайным прилагательным. Ответ должен быть кратким, только название породы с прилагательным. Например: 'Пушистый мейн-кун' или 'Грациозный сиамец'. Не добавляй никаких дополнительных слов."
