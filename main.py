...
async def get_cat_breed_from_gigachat():
    ...
    """
    prompts = [
        "Придумай случайную породу кота со случайным прилагательным. Используй разные прилагательные, например: задумчивый, игривый, грациозный, ленивый, любопытный, гордый, нежный, озорной, спокойный, элегантный. Только название породы с прилагательным.",
        "Назови одну случайную породу кота с прилагательным. Прилагательное должно быть случайным и разнообразным. Формат: [Прилагательное] [Порода]. Только эти два слова.",
        "Сгенерируй случайную комбинацию: прилагательное + порода кота. Используй разные прилагательные каждый раз. Ответ должен содержать только прилагательное и название породы.",
        "Придумай креативное описание кота: случайное прилагательное + порода. Не повторяй одни и те же прилагательные. В ответе должно быть только ДВА слова."
    ]
    ...
    try:
        ...
        payload = {
            ...
            "temperature": 0.9,  # Увеличиваем температуру для большей случайности
            "max_tokens": 50
        }
